...
# voc数据集根目录以及版本
voc_root = "E:\\数据集\\VOCtrainval_11-May-2012\\VOCdevkit"
voc_version = "VOC2012"
...
# 转换后的文件保存目录
save_file_root = "E:\\数据集\\my_yolo_dataset"

# label标签对应json文件
label_json_path = 'E:\\pythoncode\\test\\data\\pascal_voc_classes.json'
...
def create_class_names(class_dict: dict):
    ...
    with open("E:\\pythoncode\\test\\data\\my_data_label.names", "w") as w:
